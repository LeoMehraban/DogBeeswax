...
namespace DogBeeswax
{
    public class Dog
    {
        ...
        public Dog(string name, int age, DogTypes dogtype)
        {
        ...
        public  static Dog Newdog(string name, int age, bool stray , DogTypes dogtype)
        {
            Dog dog;
...
//This code is part of DogBeeswax verson 4.9.
